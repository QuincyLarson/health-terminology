...
2. Expand Unit 1 and adjacent cross-cutting lessons around the most reusable roots, prefixes, and suffixes before widening lower-yield specialty branches.
3. Add more Unit 6 long passages so synthesis feels denser than the current seed release.
...
5. Tighten spaced repetition and mixed-session tuning as the content bank grows.
