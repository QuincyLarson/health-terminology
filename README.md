...
1. Expand Unit 4 with deeper records, verification, and instruction language so it can move from `lesson-linked` to `shipped`.
...
3. Grow Unit 6 passage volume with more longer report-style, urgent-care, reproductive, pathology, immune, discharge, and administrative crossover passages.
4. Broaden the authored term bank inside the now-shipped Unit 2 and Unit 3 coverage with larger validated batches where one lesson still stands in for a whole family of real-world terms.
