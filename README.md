...
1. Expand Unit 5 with more abbreviation coverage, explicit ambiguity handling, and denser imaging, lab, route, and workflow shorthand.
2. Grow Unit 6 passage volume with more longer report-style, urgent-care, reproductive, pathology, immune, discharge, and administrative crossover passages.
3. Broaden the authored term bank inside the now-shipped Unit 2, Unit 3, and Unit 4 coverage with larger validated batches where one lesson still stands in for a whole family of real-world terms.
4. Tighten spaced repetition, mixed-session tuning, and browse or ranking behavior as the content bank grows.
