...
- Seed content exists for 7 units, 71 lessons, 89 parts, 187 terms, 213 exercises, and 32 abbreviations.
...
- Unit 2 and Unit 6 are now marked `shipped` in the seeded curriculum rather than only `lesson-linked`.
...
- Current seed totals: 7 units, 71 lessons, 89 parts, 187 terms, 213 exercises, and 32 abbreviations.
